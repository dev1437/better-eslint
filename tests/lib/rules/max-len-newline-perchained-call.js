/**
 * @fileoverview Max line length on newline per chained call
...
//------------------------------------------------------------------------------
 ...
 ruleTester.run("max-len-newline-perchained-call", rule, {
     ...
     {
         code: "a().SomeSuperLongFunction().WithAnotherLongFunctionName().WithAnotherLongFunctionName()",
         output: "a()\n.SomeSuperLongFunction()\n.WithAnotherLongFunctionName()\n.WithAnotherLongFunctionName()",
         options: [{ ignoreChainWithDepth: 5, maxLen: 60 }],
         errors: [{
             messageId: "expected",
             data: { callee: ".SomeSuperLongFunction" },
             line: 1,
             column: 4,
             endLine: 1,
             endColumn: 26
         ...
         {
             messageId: "expected",
             data: { callee: ".WithAnotherLongFunctionName" },
             line: 1,
             column: 28,
             endLine: 1,
             endColumn: 56
